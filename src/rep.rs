...
impl Issue {
    ...
    pub fn resolution_date(&self) -> Option<String> {
      self.string_field("resolution_date").and_then(|value| value.ok())
    }
    ...
    pub fn priority(&self) -> Option<Priority> {
        self.field::<Priority>("priority").and_then(|value| value.ok())
    }
    ...
    pub fn project(&self) -> Option<Project> {
        self.field::<Project>("project").and_then(|value| value.ok())
    }

    pub fn resolution(&self) -> Option<Resolution> {
      self.field::<Resolution>("resolution").and_then(|value| value.ok())
    }
}
...
impl TransitionTriggerOptions {
  ...
  pub fn new<I>(id: I) -> TransitionTriggerOptions where I: Into<String> {
  ...
  pub fn builder<I>(id: I) -> TransitionTriggerOptionsBuilder where I: Into<String> {
...
impl TransitionTriggerOptionsBuilder {
  /// creates a new instance
  pub fn new<I>(id: I) -> TransitionTriggerOptionsBuilder where I: Into<String> {
  ...
  pub fn field<N, V>(&mut self, name: N, value: V) -> &mut TransitionTriggerOptionsBuilder where N: Into<String>, V: Serialize {
    self.fields.insert(name.into(), serde_json::to_value(value).expect("Value to serialize"));
    self
  }

  /// updates resolution in transition
  pub fn resolution<R>(&mut self, name: R) -> &mut TransitionTriggerOptionsBuilder where R: Into<String> {
